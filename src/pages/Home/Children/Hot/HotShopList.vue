          ...
          <li class="shop-list-item" v-for="(shop, index) in homeshoplist" :key="index">
              ...
              <div class="list-item-bottom">
                  ...
                  <span class="item-user" >
                      <img src="./../../imgs/shop_list/user1.jpg" alt="" width="100%">
                    <img :src="user.avatar" alt="" v-for="(user, index1) in shop.bubble" :key="index1" width="100%">
            ...
            <!-- <li class="shop-list-item">
              ...
              <div class="list-item-bottom">
                  <span class="item-price">$23.0</span>
                  <span class="item-counter">已拼333件</span>
                  <span class="item-user">
                    <img src="./../../imgs/shop_list/user1.jpg" alt="" width="100%">
                    <img src="./../../imgs/shop_list/user2.jpg" alt="" width="100%">
