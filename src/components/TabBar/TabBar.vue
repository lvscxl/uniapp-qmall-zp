<template>
  <div class="bottom-tab">
        ...
        <span class="tab-item" @click="switchTo('/search')">
           <img :src="$route.path.includes('/search') === $route.path ? tabBarImgArr[2].selected : tabBarImgArr[2].normal" alt="">
           <span :class="{on: '/search' === $route.path}">搜索</span>
        </span>
        <span class="tab-item" @click="switchTo('/cart')">
        ...
        <span class="tab-item" @click="switchTo('/chat')">
           <img :src="$route.path.includes('/chat') === $route.path ? tabBarImgArr[3].selected : tabBarImgArr[3].normal" alt="">
